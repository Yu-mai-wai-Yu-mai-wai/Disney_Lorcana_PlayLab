...
const translations: Record<Language, Translations> = {
  th: {
    ...
    cost: 'ค่าร่าย (Cost)',
    inkable: 'ใส่ Inkwell ได้',
    strength: 'พลังโจมตี (Strength)',
    willpower: 'พลังชีวิต (Willpower)',
    lore: 'แต้ม Lore',
    ...
    cardsCount: 'ใบ',
    specialAbilities: 'ความสามารถพิเศษ (Abilities)',
    ...
    translateAbilities: 'แปลไทย (คงคีย์เวิร์ดอังกฤษ)',
    originalText: 'ข้อความต้นฉบับ (EN)',
    ...
    analyticsCurveDist: 'การกระจายตัวของค่าร่าย (Ink Curve)',
    analyticsTypeBreakdown: 'สัดส่วนประเภทการ์ด',
    analyticsCharacters: 'ตัวละคร (Characters)',
    analyticsActions: 'แอ็กชัน & เพลง (Actions & Songs)',
    analyticsItems: 'ไอเทม (Items)',
    analyticsLocations: 'สถานที่ (Locations)',
    analyticsOptimizationTitle: 'คำแนะนำการปรับปรุงเด็ค (AWS AI Engine)',
    analyticsOptimal: 'เหมาะสม (Optimal)',
    ...
    saveDeck: 'บันทึกเด็ค',
    deleteDeck: 'ลบเด็ค',
    exportDeck: 'ส่งออกเด็ค (Export)',
    importDeck: 'นำเข้าเด็ค (Import)',
    deckStats: 'สถิติเด็ค',
    totalCards: 'จำนวนการ์ดทั้งหมด',
    inkCurve: 'กราฟอัตราค่าร่าย (Ink Curve)',
    ...
    openBoosterPack: 'เปิดซองการ์ด (Booster Pack)',
    ...
    saveSuccess: 'บันทึกเด็คสำเร็จขึ้น AWS DynamoDB!',
    ...
    // Match Lobby
    lobbyTitle: 'ห้องดวลการ์ดออนไลน์ (Real-Time Match)',
    ...
    enterRoomCode: 'ใส่รหัสห้อง (Room Code)',
    ...
    passTurn: 'จบเทิร์น (Pass Turn)',
    quest: 'ทำเควสต์ (Quest)',
    challenge: 'โจมตีท้าดวล (Challenge)',
    exert: 'ใช้งาน (Exert)',
    ready: 'ฟื้นฟู (Ready)',
    putToInkwell: 'ใส่เป็นหมึก (Put in Inkwell)',
    discardPile: 'สุสานการ์ด (Discard Pile)',
    drawCard: 'จั่วการ์ด',
    loreScore: 'คะแนน Lore',
    availableInk: 'หมึกที่พร้อมใช้',
    diceDuel: 'ทอดลูกเต๋าตัดสิน',
    firstPlayer: 'ผู้เล่นคนแรก',
    beginningPhase: 'ช่วงเริ่มต้น (Ready / Set / Draw)',
    mainPhase: 'ช่วงเล่นหลัก (Main Phase)',
    endPhase: 'ช่วงจบเทิร์น (End Phase)',
    mulliganTitle: 'ขั้นตอนสลับการ์ดเริ่มต้น (Mulligan Phase)',
    mulliganDesc: 'เลือกการ์ดที่ต้องการเปลี่ยนกลับเข้ากอง แล้วจั่วการ์ดใหม่ตามจำนวนที่เลือก',
    keepHand: 'เก็บมือนี้ (Keep Hand)',
    mulliganAction: 'เปลี่ยนการ์ดที่เลือก (Mulligan)',
    victory: '🏆 ยินดีด้วย! คุณได้รับชัยชนะ!',
    defeat: '💀 คุณพ่ายแพ้ในศึกนี้',
    damage: 'ดาเมจ',
    exerted: 'ใช้งานแล้ว (Exerted)',
    readyStatus: 'พร้อมใช้งาน (Ready)',
    drying: 'เพิ่งลงสนาม (Ink Drying)',
    actionLog: 'บันทึกการเล่น (Action Log)',
  ...
  en: {
    ...
    analyticsOptimizationTitle: 'Deck Optimization Insights (AWS AI Engine)',
    ...
    saveSuccess: 'Saved successfully to AWS DynamoDB!',
